      ...
      <v-card-text>
        <template>
          <v-form v-model="valid" ref="form" lazy-validation>
            ...
            <div class="subheading secondary--text text--lighten-2">Disable User<span v-if="disabled"> (Currently Disabled)</span><span v-else> (Currently Active)</span></div>
...
export default class CreateUser extends Vue {
  ...
  public async submit() {
    if (await this.$validator.validateAll()) {
      ...
      updatedProfile.disabled = this.disabled;
